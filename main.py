...
def start_game():
  ...
  #dealer plays until over 17
  while (sum(computer_hand) < 17):
    deal(1, "computer")
  
  #repeat asking if under 21
  while (sum(hand) < 21):
  ...
  #once player stops, reveal both hands and final scores
  print(f"Your final hand: {hand}, {display(hand)} final score: {sum(hand)}")
  print(f"Computer's final hand: {computer_hand}, {display(computer_hand)} final score: {sum(computer_hand)}")
  if sum(hand) > 21:
